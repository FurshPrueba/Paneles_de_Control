...
$(document).ready(function(){
    ...
    $(document).on('click', '.iconoBorrarArea', function(){
        ...
        function invocarVentanaEmergenteBorrar(tipoRespuesta){
            $.ajax({
                ...
                data: {
                    ...
                    tipoDeSituacion: 'borrarArea', //esta es el tipo de situacion que va a ser invocada (puede ser de anular, agregar o de error)
                },
                dataType: 'html'
            }).done(function(data){
        ...
        AreaABorrar = $(this).parent()[0].id;
        area = $(this).closest('.Area')[0].id;

        console.log(AreaABorrar);
